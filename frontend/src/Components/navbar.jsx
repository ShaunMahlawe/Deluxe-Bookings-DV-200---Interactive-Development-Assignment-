...
function NavBar() {
  ...
  <nav>
        ...
        <Link to="/login" className='primaryButton inter-regular buttontext col-4'>Create account <img src={Followbutton} alt="arrow icon" className='searchButton'/></Link>
        
         <Dropdown className="d-flex flex-row-reverse dropdown">
      <Dropdown.Toggle variant="light" id="dropdown-basic" className="dropdowntext"> Your account
      </Dropdown.Toggle>
      <Dropdown.Menu>
        <Dropdown.Item> 
        ...
        <Dropdown.Item> 
            <Link to="/account" className="dropdownlinks">
            <img src={luggageicon} alt="User Icon" className='dropdownIcons'/>Bookings</Link> 
        </Dropdown.Item>
        
        <Dropdown.Item> 
            <Link to="/account" className="dropdownlinks">
            <img src={Walleticon} alt="User Icon" className='dropdownIcons'/>Wallet</Link> 
        </Dropdown.Item>

        <Dropdown.Item> 
            <Link to="/account" className="dropdownlinks">
            <img src={UserStaricon} alt="User Icon" className='dropdownIcons'/>Reviews</Link> 
        </Dropdown.Item>

        <Dropdown.Item> 
            <Link to="/account" className="dropdownlinks">
            <img src={Hearticon} alt="User Icon" className='dropdownIcons'/>Saved</Link> 
        </Dropdown.Item>

        <Dropdown.Item> 
            <Link to="/account" className="dropdownlinks">
            <img src={LogOuticon} alt="User Icon" className='dropdownIcons'/>Sign out</Link> 
        </Dropdown.Item>
      </Dropdown.Menu>
    </Dropdown>
      </nav>
